...
public class RedstoneWireBlockBehavior extends SimpleBlockBehavior {
    public static final RedstoneWireBlockBehavior INSTANCE = new RedstoneWireBlockBehavior();
