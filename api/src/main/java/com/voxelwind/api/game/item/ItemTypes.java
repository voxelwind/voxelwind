...
public class ItemTypes {
    ...
    public static final ItemType GOLDEN_SWORD = new IntItem(283, "golden_sword", 1, null);
    public static final ItemType GOLDEN_SHOVEL = new IntItem(284, "golden_shovel", 1, null);
    public static final ItemType GOLDEN_PICKAXE = new IntItem(285, "golden_pickaxe", 1, null);
    public static final ItemType GOLDEN_AXE = new IntItem(286, "golden_axe", 1, null);
    ...
    public static final ItemType GOLDEN_HOE = new IntItem(294, "golden_hoe", 1, null);
    ...
    public static final ItemType MINECART_WITH_CHEST = new IntItem(342, "minecart_with_chest", 1, null);
    ...
    public static final ItemType FILLED_MAP = new IntItem(358, "filled_map", 64, null);
    ...
    public static final ItemType FIRE_CHARGE = new IntItem(385, "fire_charge", 64, null);
    public static final ItemType EMERALD = new IntItem(388, "emerald", 64, null);
    public static final ItemType ITEM_FRAME = new IntItem(389, "item_frame", 64, null);
    ...
    public static final ItemType MAP = new IntItem(395, "map", 64, null);
    ...
    public static final ItemType LEATHER_HORSE_ARMOR = new IntItem(416, "leather_horse_armor", 1, null);
    public static final ItemType IRON_HORSE_ARMOR = new IntItem(417, "iron_horse_armor", 1, null);
    public static final ItemType GOLDEN_HORSE_ARMOR = new IntItem(418, "golden_horse_armor", 1, null);
    ...
    public static final ItemType RAW_SALMON = new IntItem(460, "raw_salmon", 64, null);
    ...
    public static final ItemType ENCHANTED_GOLDEN_APPLE = new IntItem(466, "enchanted_golden_apple", 64, null);
