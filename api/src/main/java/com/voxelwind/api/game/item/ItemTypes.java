...
public class ItemTypes {
    ...
    public static final ItemType LEATHER_CAP = new IntItem(298, "leather_cap", 1, GenericDamageValue.class);
    public static final ItemType LEATHER_TUNIC = new IntItem(299, "leather_tunic", 1, GenericDamageValue.class);
    public static final ItemType LEATHER_PANTS = new IntItem(300, "leather_pants", 1, GenericDamageValue.class);
